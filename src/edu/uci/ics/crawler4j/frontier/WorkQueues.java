...
public class WorkQueues {
  ...
  protected Transaction beginTransaction() throws DatabaseException {
    return resumable ? env.beginTransaction(null, null) : null;
  }

  protected static void commit(Transaction tnx) throws DatabaseException {
    if (tnx != null) {
      tnx.commit();
    }
  }

  protected Cursor openCursor(Transaction txn) throws DatabaseException {
  ...
  public long getLength() throws DatabaseException {
    return urlsDB.count();
  }
